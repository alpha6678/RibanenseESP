 ...
 * do usuario mora no cartao, que ainda nao foi montado. */
...
/* Monta as telas. Sai do splash quando o ponto de restauracao desta
 * versao estiver no cartao, ou quando a tentativa falhar de fato. */
